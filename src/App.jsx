...
function App() {
  ...
  return (
    <div>
      ...
      <TextBlock title="Boil the water" text="Press the start button located on your kettle to start boiling the water"></TextBlock>
      <TextBlock title="Prepare the tea leaves" text="Measure out the desired amount of dry tea leaves. It is generally recommended to use one teaspoon of tea leaves for every 6 ounces of water. This equates to one cup of tea"></TextBlock>
